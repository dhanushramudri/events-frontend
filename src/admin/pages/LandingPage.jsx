...
const LandingPage = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      description:
        "Manage registrations and attendance with powerful analytics",
      image: "attendees.svg",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 font-sans overflow-hidden relative">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <svg
          className="absolute top-0 right-0 w-64 h-64 text-purple-200 transform rotate-12 opacity-60"
          viewBox="0 0 200 200"
          fill="currentColor"
        >
        ...
        <svg
          className="absolute bottom-0 left-0 w-56 h-56 text-indigo-200 opacity-60"
          viewBox="0 0 200 200"
          fill="currentColor"
        >
        ...
        <svg
          className="absolute top-1/4 left-1/4 w-32 h-32 text-purple-300 animate-pulse opacity-30"
          viewBox="0 0 200 200"
          fill="currentColor"
        >
        ...
        <div className="flex flex-col md:flex-row items-center mb-24">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8">
              Create, manage, and promote your events with our all-in-one
              platform. Designed for organizers who want to make an impact.
            </p>
            <div className="flex space-x-4">
              <Button
                variant="gradient"
          ...
          <div className="flex flex-col md:flex-row justify-between">
            <div className="mb-8 md:mb-0">
              ...
              <p className="text-gray-600 max-w-sm">
                The all-in-one platform for creating and managing extraordinary
                events.
              </p>
            </div>
